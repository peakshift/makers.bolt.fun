...
export default function ProjectsList(props: Props) {
  ...
  const [queryFilter, setQueryFilter] =
    useState<GetProjectsInTournamentQueryVariables>({
  ...
  useEffect(() => {
    ...
    setQueryFilter((f) => ({
      ...
      trackId: props.trackIdFilter,
      roleId: props.roleFilter === null ? -1 : props.roleFilter,
      skip: 0,
    }));
  }, [props.trackIdFilter, props.searchFilter, props.roleFilter]);
  ...
  const itemsCount =
    query.data?.getProjectsInTournament &&
    ...
    <div>
      ...
      <div className="flex flex-col gap-16 lg:gap-24">
        ...
        <div className="flex justify-center gap-36 text-gray-400">
          <IconButton
            isDisabled={!query.data?.getProjectsInTournament.hasPrev}
            onClick={prevPage}
          >
            <FaChevronLeft />
          </IconButton>
          <IconButton
            isDisabled={!query.data?.getProjectsInTournament.hasNext}
            onClick={nextPage}
          >
            <FaChevronRight />
          </IconButton>
