...
export default function ParticipantsSection({ tournamentId }: Props) {
  ...
  const [curTab, setCurTab] = useState<
    "all-makers" | "makers-to-team" | "projects"
  >((state as any)?.makersLookingToTeam ? "makers-to-team" : "all-makers");
    ...
    <>
      ...
      {curTab === "projects" && (
        <ProjectsList
          ...
          trackIdFilter={null}
          roleFilter={roleFilter?.id ?? null}
          tournamentId={tournamentId}
        />
      )}
      {curTab !== "projects" && (
        <MakersList
          onlyLookingToTeam={curTab === "makers-to-team"}
          searchFilter={debouncedsearchFilter}
          roleFilter={roleFilter?.id ?? null}
          tournamentId={tournamentId}
        />
