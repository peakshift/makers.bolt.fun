...
type ProjectType =
  GetProjectsInTournamentQuery["getProjectsInTournament"]["projects"][number];
    ...
    <Card>
      <div className="flex flex-wrap gap-24 items-start">
        <img
          ...
          className="shrink-0 w-64 md:w-80 aspect-square rounded-16 outline outline-2 outline-gray-200"
          alt=""
        />
        <div className="flex flex-col gap-4 flex-1 overflow-hidden">
          <p className="text-body2 text-gray-900 font-bold">{project.title}</p>
          <p className="text-body4 text-gray-600 font-medium">
            {project.category.icon} {project.category.title}
          </p>
          <div className="hidden md:block">
            <p className="text-body5 text-gray-400 line-clamp-2 max-w-[60ch]">
              {project.description}{" "}
            </p>
          </div>
        </div>
      ...
      <p className="md:hidden mt-24 text-body5 text-gray-400 line-clamp-2 max-w-[60ch]">
        {project.description}{" "}
      </p>
      {showLookingFor && (
        <div className="mt-24">
          <p className="text-body5 text-gray-900 font-medium mb-12">
            👀 Looking for
          </p>
