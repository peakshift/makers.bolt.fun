  ...
  return (
    ...
    >
      <div className="relative h-[160px]">
        ...
        <button
          className="w-32 h-32  bg-gray-700 text-white absolute top-16 right-16 rounded-full flex flex-col justify-center items-center"
          onClick={closeModal}
        >
          <MdClose className=" inline-block text-body2 lg:text-body1" />
        </button>
        <span
          className={`absolute top-16 left-16 text-body5 self-start px-8 py-4 rounded-20 bg-gray-700 text-white `}
        >
        ...
        <div className="flex gap-16 mt-8">
          ...
          <p className="text-body4 font-medium text-primary-600 overflow-hidden whitespace-nowrap text-ellipsis">
            ...
            <a href={event.website} target="_blank" rel="noreferrer">
              {" "}
              <span className="align-middle ">{event.website}</span>
            </a>
          </p>
        </div>
        <div
          className="text-body4 text-gray-600 mt-24 whitespace-pre-line"
