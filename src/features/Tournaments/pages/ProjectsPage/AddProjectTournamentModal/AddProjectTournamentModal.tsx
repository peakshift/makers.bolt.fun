     ...
     `}>
                ...
                {!!selectedProject && <div>
                    ...
                    <InfoCard className='mt-8'>
                        <span className="font-bold"> ℹ️ Tracks:</span> All projects will automatically be registered for the Grand Prize, however makers can select an additional track to enter. <a href="https://makers.bolt.fun/story/boltfun-tournaments-are-here--107" className='text-blue-500' target='_blank' rel="noreferrer" >Learn more about how our tracks work.</a>
                    </InfoCard>
                </div>}
...
const SelectProjectValueContainer = ({ children, ...props }: ValueContainerProps<Project>) => {
