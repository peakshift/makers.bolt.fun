...
import {
  ...
  GetTournamentByIdQueryVariables,
  MeTournamentDocument,
  MeTournamentQueryVariables,
...
const schema: yup.SchemaOf<IFormInputs> = yup
  .object({
    ...
    agreement: yup
      ...
      .required()
      .isTrue(
        "You won't be able to follow the updates/events of the tournament if you don't allow this"
      ),
  })
  .required();
  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="flex flex-col gap-24 p-16 md:p-24"
      >
        ...
        <div className="flex flex-col gap-8">
          <label className="text-body5 text-gray-600 font-medium">
            Hacking status
          </label>
          <Controller
            name="hacking_status"
          ...
          <InfoCard>
            <span className="font-bold">👋 Details:</span> other makers will be
            able to see your hacker card and send you Team Up requests.
          </InfoCard>
        </div>
        <div className="flex flex-col gap-8">
          <label className="text-body5 text-gray-600 font-medium">
          ...
          <div className="mt-12 flex gap-12">
            <input
              ...
              {...register("agreement", {})}
            />
            <label htmlFor="agreement" className="text-body5 text-gray-600">
          ...
          {errors.agreement && (
            <p className="input-error">{errors.agreement.message}</p>
          )}
        </div>
