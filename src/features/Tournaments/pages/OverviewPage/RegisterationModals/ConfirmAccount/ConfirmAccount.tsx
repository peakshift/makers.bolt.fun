    ...
    >
      ...
      <div className="flex flex-col justify-center gap-16 items-center text-center p-16 md:p-24">
        ...
        <div className="flex flex-col gap-4 overflow-hidden max-w-full">
          <p className="text-body3 text-gray-900 text-ellipsis overflow-hidden">
            {me.name}
          </p>
        ...
        <p className="text-body4 text-gray-600">
          You are currently signed in using this profile. Would you like to
          continue with your ⚔️ Tournament registration?
        </p>
