...
export default function LinkingAccountModal({
  ...
  if (error)
    ...
    content = (
      <div className="flex flex-col gap-24 py-48 items-center">
    ...
    content = (
      <div className="flex flex-col justify-center gap-24 items-center text-center">
        ...
        <p className="text-gray-600 text-body4 text-left">
          ...
          this is very easy!
          <br />
          To sign in or create an account, just scan this QR, or click to
          connect using any lightning wallet like{" "}
          <a
  ...
  return (
    ...
    >
      ...
      <div className=" p-16 md:p-24">{content}</div>
    </motion.div>
  );
}
