...
import {
  UpdateUserRolesSkillsMutationVariables,
  useMyProfileRolesSkillsQuery,
  useUpdateUserRolesSkillsMutation,
...
export type IRolesSkillsForm = NonNullable<
  UpdateUserRolesSkillsMutationVariables["data"]
>;

const schema: yup.SchemaOf<IRolesSkillsForm> = yup
  .object({
    roles: yup
      .array()
      .of(
...
export default function PreferencesTab() {
  ...
  if (!query.data || !query.data?.me) return <NotFoundPage />;
