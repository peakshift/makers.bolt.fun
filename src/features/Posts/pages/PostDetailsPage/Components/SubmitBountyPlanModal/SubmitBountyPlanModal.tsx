...
export default function Login_SuccessCard({
  onClose,
  direction,
  ...props
}: ModalCard) {
  ...
  return (
    ...
    >
      <IoClose
        className="absolute text-body2 top-32 right-32 hover:cursor-pointer"
        onClick={onClose}
      />
      <form onSubmit={handleSubmit(onSubmit)}>
        <h2 className="text-h5 font-bolder">Submit a plan</h2>
        <p className="text-body4 mt-8">
          Please provide an action plan & ask any initial questions you have for
          this ticket
        </p>
        ...
        <div className="grid sm:grid-cols-2 gap-24 mt-16">
          <div>
            <label className="text-body5 text-gray-600 font-medium" htmlFor="">
              First Draft
            </label>
            <Controller
              name="firstDraft"
        ...
        <div>
          <div className="mt-16 flex gap-16">
            ...
            <label className="text-body4 text-gray-600">
              ...
              approval from the funder before working
            </label>
          </div>
          <div className="mt-16 flex gap-16">
            <input
