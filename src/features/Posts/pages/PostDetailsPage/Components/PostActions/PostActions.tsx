...
export default function PostActions({ post, isPreview }: Props) {
    ...
    return (
        <div>
            <button className={`
            hidden md:flex w-full aspect-square bg-white rounded-12 border-2 border-gray-100 justify-around items-center text-gray-500 hover:bg-gray-50 active:bg-gray-100
            `}
                onClick={() => isPreview ? navigate(-1) : navigate('/blog')}
            >
                <FiArrowLeft className={"text-body1"} />
            </button>
            {/* <ul className="bg-white rounded-12 p-16 border-2 border-gray-100 flex justify-around md:flex-col gap-32">
                <li
            ...
            <ul className="bg-white rounded-12 p-16 border-2 border-gray-100 flex justify-around md:flex-col gap-32 mt-32">
