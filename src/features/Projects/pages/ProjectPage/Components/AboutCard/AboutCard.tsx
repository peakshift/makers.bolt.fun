...
interface Props {
  project: Pick<
    ProjectDetailsQuery["getProject"],
    | "id"
    | "cover_image"
    | "thumbnail_image"
    | "title"
...
export default function AboutCard({ project }: Props) {
  ...
  const canEdit = project.permissions.includes(
    ProjectPermissionEnum.UpdateInfo
  );
  ...
  return (
    <Card defaultPadding={false} onlyMd>
      ...
      <div className="hidden md:block relative rounded-t-12 md:rounded-t-16 h-[120px] lg:h-[160px]">
        <img
          className="w-full h-full object-cover rounded-12 md:rounded-0 md:rounded-t-16"
      ...
      <div className="md:p-24 md:pt-0 flex flex-col gap-24">
        ...
        <div className="flex flex-col gap-24 relative">
          <div className="flex flex-wrap justify-end items-center gap-16 min-h-[40px] mt-12">
            {canEdit && (
              <Button
                size="sm"
                color="gray"
                href={createRoute({ type: "edit-project", id: project.id })}
              >
                Edit Project
              </Button>
            )}
            <Button
              ...
              variant="outline"
              color="gray"
              className="hidden md:block hover:!text-red-500 hover:!border-red-200 hover:!bg-red-50"
              onClick={() => onVote()}
            >
          ...
          <div className="flex flex-col gap-8 items-start justify-between -mt-12">
            ...
            <div>
              <span className="font-medium text-body5 text-gray-900">
          ...
          <Button
            ...
            variant="outline"
            color="gray"
            className="md:hidden hover:!text-red-500 hover:!border-red-200 hover:!bg-red-50"
            onClick={() => onVote()}
          >
            <MdLocalFireDepartment />
            {
