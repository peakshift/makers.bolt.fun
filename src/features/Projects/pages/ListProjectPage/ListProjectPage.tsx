...
export default function ListProjectPage() {
  ...
  if (meQuery.error || !meQuery.data?.me)
      ...
      <div className="page-container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-24">
          {isMediumScreen ? (
            ...
            <aside className=" bg-white z-10 w-full sticky-top-element !col-start-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-24">
                ...
                <div className="self-start sticky-side-element">
                  <SaveChangesCard
                    currentTab={curTab}
                    onNext={() => {
                      if (curTab === "project-details")
                        setCurTab(tabs["team"].path);
                      else if (curTab === "team")
                        setCurTab(tabs["extras"].path);
                    }}
                    onBackToFirstPage={() =>
                      setCurTab(tabs["project-details"].path)
                    }
                  />
                </div>
              </div>
