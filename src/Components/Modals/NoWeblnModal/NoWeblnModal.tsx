...
export default function NoWeblnModal({
  onClose,
  direction,
  ...props
}: ModalCard) {
  ...
  if (isMobile)
    content = (
      <>
        ...
        <p className="text-body4 text-gray-600 mt-8">
          In order to use BOLT🔩FUN’s voting button, you need to use a lightning
          browser wallet like Alby. You can download the extension on your
    ...
    content = (
      <>
        ...
        <p className="text-body4 text-gray-600 mt-8">
          In order to use BOLT🔩FUN’s voting button, you’ll need to use a
          lightning browser wallet like Alby. Download it to continue.
        </p>
        <Button
          color="black"
          fullWidth
